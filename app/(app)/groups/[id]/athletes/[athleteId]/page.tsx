...
export default function AthleteProfilePage() {
  ...
  return (
    <div style={{ maxWidth: 520, margin: '0 auto', paddingBottom: 100 }}>
      ...
      {showEdit && (
        <>
          <div onClick={() => setShowEdit(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.4)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)', zIndex: 100 }} />
